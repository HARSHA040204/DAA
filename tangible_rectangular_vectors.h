...
public:
    ...
    static std::vector<std::vector<std::wstring>> RectangularStdWstringVector(int size1, int size2)
    {
        std::vector<std::vector<std::wstring>> newVector(size1);
        for (int vector1 = 0; vector1 < size1; vector1++)
        {
            newVector[vector1] = std::vector<std::wstring>(size2);
        }
